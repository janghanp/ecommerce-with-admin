                ...
                <div className="flex w-full items-center gap-x-5 rounded-md border p-3 shadow-sm">
                  ...
                  <div className="flex h-24 w-full items-end justify-between">
                    <div className="flex flex-col gap-y-1">
                      <span className="text-lg font-semibold">{orderItem.product.name}</span>
                      <span className="text-sm text-muted-foreground">size: {orderItem.size}</span>
                    ...
                    <div className="flex h-full flex-col justify-end gap-y-1">
                      <span>
                        {formatter.format(Number(orderItem.product.price) * orderItem.quantity)}
                      </span>
                      <span className="text-sm text-muted-foreground">
