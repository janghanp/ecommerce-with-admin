        ...
        >
              ...
              <div className="w-full">
                {sizeFields.map((field, index) => (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={cn(index !== 0 && "sr-only")}>Sizes</FormLabel>
                        <FormDescription className={cn(index !== 0 && "sr-only")}></FormDescription>
                      ...
                      <div className="relative flex items-end gap-x-5">
                        ...
                        {sizeFields.length > 1 && (
                          <Button
                            ...
                            size="icon"
                            type="button"
                            onClick={() => removeSizeAndQuantityField(index)}
                          >
          ...
          <div className="flex w-full max-w-md flex-col gap-y-5">
            <FormField
              ...
              name="isFeatured"
              render={({ field }) => (
                <FormItem className="flex w-full max-w-md flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  <FormControl>
                    <Checkbox
                      checked={field.value}
                      //@ts-ignore
